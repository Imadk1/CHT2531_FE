                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="ms-auto">
                            ...
                            <Nav.Link className="nav-item mx-2" as={NavLink} activeClassName='is-active' to="/now_playing">Now Playing</Nav.Link>
                            <Nav.Link className="nav-item mx-2" as={NavLink} activeClassName='is-active' to="/top_rated">Top Rated</Nav.Link>
