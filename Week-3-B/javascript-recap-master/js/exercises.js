...
console.log(`Hello ${username}. Your favourite colour is ${colour}. Your favourite website is ${url}.`)
...
if (filmObj.duration > 120) {
  console.log(`${filmObj.title} is over 2 hours.`)
} else {
  console.log(`${filmObj.title} is under 2 hours.`)
}
...
films.forEach(film => {
  console.log(`The film ${film.title} was released in ${film.year} and is ${film.duration} minutes long.`);
});
...
let searchTerms = films.filter(function (e) {
  return e.year > 2000;
});
